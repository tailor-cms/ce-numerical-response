...
Authoring component for the **Numerical Response** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-numerical-response-edit
```
...
```ts
import { Edit } from '@tailor-cms/ce-numerical-response-edit';
```
